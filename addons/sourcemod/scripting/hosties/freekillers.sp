...
Freekillers_OnPluginStart()
{
	...
	gH_Cvar_Freekill_Sound_Mode = AutoExecConfig_CreateConVar("sm_hosties_freekill_sound_mode", "1", "When to play the 'freekill sound': 0 - on freeATTACK, 1 - on freeKILL", 0, true, 0.0, true, 1.0);
