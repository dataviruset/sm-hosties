...
{
	gH_Cvar_CheckPlayersOn = AutoExecConfig_CreateConVar("sm_hosties_checkplayers_enable", "1", "Enable or disable the !checkplayers command: 0 - disable, 1 - enable", 0, true, 0.0, true, 1.0);
